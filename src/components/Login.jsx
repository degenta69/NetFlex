...
const Login = () => {
  ...
  const handleLogin = async e => {
    ...
    try {
      ...
      const userToken = await authUser.user.getIdToken(true).then(token => {
        return token
      })
  ...
  return (
    <header className='h-screen bg-blend-luminosity relative text-white bg-cover bg-center object-fill bg-netflex-banner'>
              ...
              <div className='container py-3 h-72'>
                <div className='row d-flex justify-content-center align-items-center h-72'>
                  <div className='col-12 col-md-8 col-lg-6 col-xl-5'>
                    <div
                      className='card bg-button_netflex bg-opacity-90 text-white'
                      style={{ borderRadius: '1rem' }}
                    >
                      <div className='card-body p-5 text-center'>
                        <div className='md-5 -mb-0.5 mt-md-4 pb-0'>
                          <h2 className='fw-bold text-2xl mb-2 text-uppercase'>
                            Login
                          </h2>
